...
package me.lucko.spark.fabric.deobfuscator;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import me.lucko.spark.fabric.FabricSparkMod;
import me.lucko.spark.fabric.deobfuscator.mapping.MappingReader;
import me.lucko.spark.fabric.deobfuscator.mapping.TinyMappingV2Reader;
import me.lucko.spark.fabric.deobfuscator.yarn.OnlineMappingProvider;
...
public class StackTraceDeobfuscator
{
	...
	{
		if (!fetchedMapping || !MAPPING.containsKey(className))
		{
			return Optional.empty();
		}
		return Optional.of(MAPPING.get(className));
	}

	public static Optional<String> remapMethod(String methodName)
	{
		if (!fetchedMapping || !MAPPING.containsKey(methodName))
		{
			return Optional.empty();
		}

		return Optional.of(MAPPING.get(methodName));
	}
}
