...
public enum SourceDebugCache {
    ...
    private static final class SmapValue {
        private final String value;

        public static final SmapValue NULL = new SmapValue(null);

        private SmapValue(String value) {
            this.value = value;
        }

        public static SmapValue of(String value) {
            if (value == null) {
                return NULL;
            } else {
